...
1. 대사 편집기를 활용하여 원하는 대사의 음성 파일, 립싱크 파일을 생성한다.
2. 대사 생성기를 통해 만들어진 대사 db를 활용하여 스크립트 편집기로 Actionscript를 생성한다.
3. 시나리오 편집기에서 사용 할 토픽, 토픽의 순서, 사용 할 Actionscript, 재생 모드를 세팅한다.
4. 위의 과정을 통해 생성된 파일들을 정해진 위치에 준비한 뒤 ARINBODY를 실행한다.
